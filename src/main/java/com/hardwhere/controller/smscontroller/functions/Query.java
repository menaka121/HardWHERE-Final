package com.hardwhere.controller.smscontroller.functions;
...
public class Query  extends HttpServlet {
    ...
    public ArrayList<Item> getItemsByrPrice(String ItemName) throws UnknownHostException {
    ...
    public ArrayList<Item> getItemList(String item_Type,String itemModel,String itemBrand,String itemSize,String itemThickness){
